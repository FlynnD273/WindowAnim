...
while True:
    ...
    x = math.cos(t * 2 * math.pi * 0.5) * 100 + screen_width / 2 - w / 2
    y = math.sin(t * 2 * math.pi * 0.5) * 100 + screen_height / 2 - h / 2
    setpos(window, x, y, w, h)
    window.update_idletasks()
    window.update()
# math.cos(t / 2 / math.pi / 20) * 50 + 
# math.sin(t / 2 / math.pi / 20) * 50 + 
